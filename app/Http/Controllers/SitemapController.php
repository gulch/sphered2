...
class SitemapController extends Controller
{
    public function generateSitemap()
    {
        ...
        $sitemap->add(url('whatwedo'), date('Y-m-d H:i:s'), '0.7', 'weekly');
        $sitemap->add(url('history'), date('Y-m-d H:i:s'), '0.7', 'weekly');
        ...
        $sitemap->add(url('gallery'), date('Y-m-d H:i:s'), '0.9', 'weekly');
        $sitemap->add(url('portfolio'), date('Y-m-d H:i:s'), '0.9', 'weekly');
