                    ...
                    @if(sizeof($types))
                        ...
                        <li class="item dib">
                            <a class="button {{ Request::segment(2) == $type->itemType->url_segment ? 'active' : '' }}"
                               href="/gallery/{{ $type->itemType->url_segment }}">
                                {{ $type->itemType->title }}
                            </a>
                        </li>
                        @endforeach
                    ...
                    @if(sizeof($categories))
                        ...
                        <li class="item dib">
                            <a class="button {{Request::segment(3)==$category->itemCategory->url_segment ? 'active category_active_btn':''}}"
                               href="/gallery/{{ $selected_type.'/'.$category->itemCategory->url_segment }}"
                            >
                                ...
                                <div class="fc_wrapper">
                                    <div class="content">
                                        <h6 class="content_title">
                                            <a class="tc2"
                                               href="/gallery/{{ $item->itemType->url_segment.'/'.$item->itemCategory->url_segment.'/'.$item->url_segment }}"
                                            >
                                                {{ $item->itemRUS->title }}
                                            </a>
                                        </h6>
                                        <div class="category">
                                            ...
                                            <h4 class="name dib tc2">{{ $item->itemType->title }}</h4>
                                        </div>
                                    </div>
                                </div>
                            </figcaption>
