...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td height="10px" colspan="4" style="background: url('{{URL::to('/')}}/img/stripe.png') repeat-x top left"></td>
    </tr>
    <tr>
        <td colspan="4">&nbsp;</td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="2">
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="79px">
                        <img src="{{URL::to('/')}}/img/logo_48x48.png" width="48" height="48" alt="Sphered"/>
                    </td>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr style="font-family: sans-serif; font-size: 11px; font-weight: bold;">
                                <td>
                                    ...
                                    <b style="color: #7adbfa;">W:</b>&nbsp;<a style="text-decoration: none; color: #313131;" href="http://sphered.com.ua/" target="_blank" alt="Наш веб-сайт">sphered.com.ua</a></td>
                            </tr>
                        </table>
                    </td>
                </tr>
    ...
    <tr>
        ...
        <td colspan="2" width="40px" style="font-family: sans-serif; font-size: 11px; vertical-align: bottom; color: #525252;">
            ...
            <a href="http://www.facebook.com/sphered.com.ua" target="_blank"><img width="32" height="32" src="{{URL::to('/')}}/img/fb32.png"/></a>
            <a href="https://plus.google.com/+SpheredUa" target="_blank"><img width="32" height="32" src="{{URL::to('/')}}/img/gp32.png"/></a>
            <a href="http://www.pinterest.com/sphered/" target="_blank"><img width="32" height="32" src="{{URL::to('/')}}/img/pin32.png"/></a>
        </td>
        <td width="24px">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="24px">&nbsp;</td>
        <td colspan="2" style="font-family: sans-serif; font-size: 10px; vertical-align: bottom; color: #525252;">Если сообщение отображается некорректно, то нажмите «Показать картинки»</td>
        <td width="24px">&nbsp;</td>
    </tr>
</table>
</body>
